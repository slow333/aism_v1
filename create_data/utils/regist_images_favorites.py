# 1. 필요한 모듈을 가져옵니다.
from todos.models import Favorite
...
image_folder_path = r'B:\images\idol'
# 3. 폴더가 존재하는지 확인합니다.
...
# exec(open('create_data/regist_images_favorites.py', encoding='utf-8').read())
