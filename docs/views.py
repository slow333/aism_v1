...
# ============= AI ========================
def ai_python(requst):
    return render(requst, 'docs/ai/ai_python.html')

def ai_numpy(requst):
    return render(requst, 'docs/ai/numpy.html')

def ai_matplot(requst):
    return render(requst, 'docs/ai/matplot.html')

def ai_pandas(requst):
    return render(requst, 'docs/ai/pandas.html')

# ============= django ========================
def django_django_tips(requst):
    return render(requst, 'docs/django/django-tips.html')
